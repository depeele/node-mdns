...
Pack.prototype.uint8 = function(value) {
    ...
    {
        self.error = new Error("truncated writing uint8 @ "+ self.offset);
        return null;
    }
...
Pack.prototype.uint16 = function(value) {
    ...
    if ((self.offset + produce) > self.end)
    {
        self.error = new Error("truncated writing uint16 @ "+ self.offset);
        return null;
    }
...
Pack.prototype.uint32 = function(value) {
    ...
    if ((self.offset + produce) > self.end)
    {
        self.error = new Error("truncated writing uint32 @ "+ self.offset);
        return null;
    }
...
Pack.prototype.data = function(value) {
    ...
    if ((self.offset + produce) > self.end)
    {
        self.error = new Error("truncated writing "+ produce
...
Pack.prototype.AAAA = function(value) {
    ...
    if ((self.offset + produce) > self.end)
    {
        self.error = new Error("truncated writing AAAA @ "+ self.offset);
        return null;
    }
...
Pack.prototype.charString  = function(value) {
    ...
    {
        self.error = new Error("truncated writing charString @ "+ self.offset);
        return null;
    }
