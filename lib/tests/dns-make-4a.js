...
message.addAnswer(name, 'SOA', 'IN', 1, {
...
message.addAnswer(name, 'TXT', 'IN', 2, {txt: ['Hello World']} );
message.addAnswer(name, 'MX',  'IN', 3, {preference:10, exchange:'mail.'+name});

message.addAuthority(name, 'NS',  'IN', 4, {ns: 'ns1.'+ name});
message.addAuthority(name, 'NS',  'IN', 5, {ns: 'ns2.'+ name});
message.addAuthority(name, 'NS',  'IN', 6, {ns: 'ns3.'+ name});
message.addAuthority(name, 'NS',  'IN', 7, {ns: 'ns4.'+ name});

message.addAdditional('mail.'+ name, 'A', 'IN',  8, {a: '127.0.0.1'});
message.addAdditional('ns1.'+ name,  'A', 'IN',  9, {a: '127.0.0.1'});
message.addAdditional('ns2.'+ name,  'A', 'IN', 10, {a: '127.0.0.2'});
message.addAdditional('ns3.'+ name,  'A', 'IN', 11, {a: '127.0.0.3'});
message.addAdditional('ns4.'+ name,  'A', 'IN', 12, {a: '127.0.0.4'});
