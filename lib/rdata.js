...
RData.prototype.toString  = function(prefix, lineLen) {
    ...
    keys.forEach(function(key) {
        ...
        tmp = Util.format("%s:%s", key, self[key]);
...
/** @brief  Given a Resource Record class, return the equivilent string.
 *  @param  class   The class [ this.rr.class ];
 *
 *  @return The matching string.
 */
RData.prototype.class2str = function(rClass) {
    rClass = rClass || this.rr.class;
