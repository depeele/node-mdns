...
/** @brief  Given the provided buffer, unpack the RDATA.
 ...
 */
RData.prototype.unpack   = function(buf, offset, length) {
    var self    = this;
    ...
    case 1:     // A        (IPv4 ADDRESS)
        ...
        self.a = [
            msg.unpackUInt8(buf, offset    ),
            msg.unpackUInt8(buf, offset + 1),
            msg.unpackUInt8(buf, offset + 2),
            msg.unpackUInt8(buf, offset + 3)
        ].join('.');                                        offset += 4;
        break;
    ...
    case 11:    // WKS      (IPv4 ADDRESS, PROTOCOL, BITMAP)
        if (nBytes < 6)
        {
            self.error = new Error("'WKS' requires at least 6 bytes @ "
                                                                + offset);
            return false;
        }
    ...
    case 28:    // AAAA     (IPv6 ADDRESS)
        ...
        self.aaaa = [
                Utils.octet2hex(msg.unpackUInt8(buf, offset     )),
    ...
    case 47:    // NSEC
        ...
        self.typeBitMaps    = buf.slice( offset );
        break;
