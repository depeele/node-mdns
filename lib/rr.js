...
function RR(msg, config)
{
    ...
    if (self.class & 0x8000)
    {
        /* mDNS -- this record is a member of a unique RRSet, and the entire
         *         RRSet has been sent together.
         */
        self.uniqueRRSet  = 0x8000;
        self.class       &= 0x7fff;
    }
