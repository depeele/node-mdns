 ...
 *
 *  @return The new RR instance (null on error).
 */
Message.prototype.addRR = function(rName, rType, rClass, rTtl, rData) {
    var self        = this,
        intType     = (typeof rType === 'string'
                        ? self.str2type(rType)
                        : rType),
        intClass    = (typeof rClass === 'string'
                        ? self.str2class(rClass)
                        : rClass);
