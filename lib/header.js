...
/** @brief  Given the provided buffer, parse out the header information.
 ...
 */
Header.prototype.parse  = function(buf, offset) {
    offset = offset || 0;
    ...
    self.id      = Utils.parseUInt16(buf, offset); offset += 2;

    u16          = Utils.parseUInt16(buf, offset); offset += 2;
    ...
    self.qdCount = Utils.parseUInt16(buf, offset); offset += 2;
    self.anCount = Utils.parseUInt16(buf, offset); offset += 2;
    self.nsCount = Utils.parseUInt16(buf, offset); offset += 2;
    self.arCount = Utils.parseUInt16(buf, offset); offset += 2;
