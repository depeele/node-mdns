...
Header.prototype.parse  = function(buf, offset) {
    ...
    self.id      = msg.parseUInt16(buf, offset); offset += 2;

    u16          = msg.parseUInt16(buf, offset); offset += 2;
    ...
    self.qdCount = msg.parseUInt16(buf, offset); offset += 2;
    self.anCount = msg.parseUInt16(buf, offset); offset += 2;
    self.nsCount = msg.parseUInt16(buf, offset); offset += 2;
    self.arCount = msg.parseUInt16(buf, offset); offset += 2;
